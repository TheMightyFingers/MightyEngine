...
Component.TextOnEntity.prototype = {
	...
	setUpFont: function(){
		if(typeof this.data.color === 'undefined') this.data.color = {color: '#000000', drawShadow: false};
		if(typeof this.data.shadow === 'undefined') this.data.shadow = {color: '#000000', shadowOffsetX: 0, shadowOffsetY: 0, shadowBlur: 0};
